...
function reset() {
  ...
  record.value = DEFAULT_RECORD
  students.value = [
    { fullName: 'John Doe', dateOfBirth: '01/01/1990', mobilePhone: '1234567890', email: 'jdoe@localhost' },
    { fullName: 'Jane Smith', dateOfBirth: '03/15/1992', mobilePhone: '9876543210', email: 'jsmith@example.com' },
    { fullName: 'Michael Brown', dateOfBirth: '07/22/1985', mobilePhone: '5551234567', email: 'mbrown@test.com' },
    { fullName: 'Emily Davis', dateOfBirth: '11/30/1995', mobilePhone: '4449876543', email: 'edavis@domain.com' },
    { fullName: 'Robert Wilson', dateOfBirth: '09/10/1988', mobilePhone: '6665554444', email: 'rwilson@localhost' },
    { fullName: 'Sarah Johnson', dateOfBirth: '05/05/1993', mobilePhone: '7778889999', email: 'sjohnson@example.org' },
  ]
  search.value = ''
}
</script>
